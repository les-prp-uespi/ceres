...
class Auditorio extends StatefulWidget {

  @override
  _AuditorioState createState() => _AuditorioState();
}

class _AuditorioState extends State<Auditorio> {
  @override
          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('assets/AudiFundo.png'),
                fit: BoxFit.cover,
              ),
            ),
...
class AuditorioReserv extends StatefulWidget {
  @override
  _AuditorioReservState createState() => _AuditorioReservState();
}

class _AuditorioReservState extends State<AuditorioReserv> {
