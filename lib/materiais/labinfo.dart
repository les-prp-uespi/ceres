  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: <Widget>[
          Container(
            child: Image.asset('assets/LaboratorioInfo.png',
              height: 250.0,
              width: 250.0,
            ),
          ),
          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('assets/LabInfoFundo.png'),
                fit: BoxFit.cover,
              ),
            ),
...
class LabInfoReserv extends StatefulWidget {
  @override
  _LabInfoReservState createState() => _LabInfoReservState();
}

class _LabInfoReservState extends State<LabInfoReserv> {
