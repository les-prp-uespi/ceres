...
class XDTeladeSalas extends StatelessWidget {
  XDTeladeSalas({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(23.0, 112.0),
            child:
                // Adobe XD layer: 'Image Lists / Eleme…' (none)
                SpecificRectClip(
              rect: Rect.fromLTWH(0, 0, 315, 199),
                          ...
                          children: <Widget>[
                            Transform.translate(
                              ...
                              child:
                                  ...
                                  Stack(
                                children: <Widget>[
                                  // Adobe XD layer: 'auditorio' (shape)
                                  Container(
                                    width: 156.0,
                                    height: 198.0,
          ...
          Transform.translate(
            offset: Offset(19.0, 410.0),
            child:
                // Adobe XD layer: 'Image Lists / Eleme…' (none)
                SpecificRectClip(
              rect: Rect.fromLTWH(0, 0, 315, 197),
              child: UnconstrainedBox(
                alignment: Alignment.topLeft,
                child: Container(
                  width: 316,
                          ...
                          children: <Widget>[
                            Transform.translate(
                              ...
                              child:
                                  ...
                                  Stack(
                                children: <Widget>[
                                  // Adobe XD layer: 'meeting-room' (shape)
                                  Container(
                                    width: 156.0,
                                    height: 198.0,
                                    decoration: BoxDecoration(
