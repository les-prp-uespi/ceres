...
class _TelaCadastraReservaState extends State<TelaCadastraReserva>{
          ...
          return AlertDialog(
            ...
            content: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(widget.rOUe?
                  "Material:  ${widget.recurso.nome}":
                    widget.reserva.nomeMaterial,
                ...
                switch (widget.rOUe){
                  case true:
                    ...
                    switch (_statusCode) {
                      case 500:
                        _mostraDialog(
                            "Erro", "Não foi possível concluir a reserva");
                        break;
                      case 201:
                        Navigator.pop(context);
                    }
  ...
  void _salvar() async{
    ...
    if (_data == null || _hi == null || _hf == null){
      ...
      if (int.parse(_hi.replaceAll(new RegExp(':'), '')) >=
          int.parse(_hf.replaceAll(new RegExp(':'), ''))) {
        _mostraDialog("Horas Inválidas",
            "O Horário inicial NÃO pode ser Maior ou Igual o Horário final");
      }else{
        _confirmarResrva();
      }
    }
            ...
            child: ListView(
              children: <Widget>[
                Container(
                  ...
                  child: TableCalendar(
                    //initialSelectedDay: widget.rOUe?
