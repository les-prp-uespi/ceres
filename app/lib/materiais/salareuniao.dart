...
class SalaReuniao extends StatefulWidget {
  @override
  _SalaReuniaoState createState() => _SalaReuniaoState();
}

class _SalaReuniaoState extends State<SalaReuniao> {
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: <Widget>[
          Container(
            child: Image.asset('assets/SalaDeReuniao.png',
              height: 250.0,
              width: 250.0,
            ),
          ),
          Text("Sala de Reinião",
        ...
        Container(
          decoration: BoxDecoration(
            image: DecorationImage(
                image: AssetImage('assets/SalaDeReuniaoFundo.png'),
            fit: BoxFit.cover,
            ),
          ),
...
class SalaReuniaoReserv extends StatefulWidget {
  @override
  _SalaReuniaoReservState createState() => _SalaReuniaoReservState();
}

class _SalaReuniaoReservState extends State<SalaReuniaoReserv> {
  //Função para botao de informação
